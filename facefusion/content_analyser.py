...
MODELS : Dict[str, ModelValue] =\
{
	'open_nsfw':
	{
		'url': 'https://facetool-us.s3.amazonaws.com/resources/facetool/facefusion/open_nsfw.onnx',
		'path': resolve_relative_path('../.assets/models/open_nsfw.onnx') if facefusion.globals.base_root_path is None else os.path.join(facefusion.globals.base_root_path, '.assets/models/open_nsfw.onnx')
	}
}
